...
struct MentionFormatterTests {
    private func makeIndexedFile(
        absolutePath: String = "/workspace/SuperduperDictation/Services/AppCoordinator.swift",
        relativePath: String = "SuperduperDictation/Services/AppCoordinator.swift",
    ...
    private func makeCandidate(relativePath: String = "SuperduperDictation/Services/AppCoordinator.swift", score: Double = 0.9) -> PathCandidate {
    ...
    @Test func formatsResolvedMentionForSupportedApp() {
        ...
        #expect(text == "@SuperduperDictation/Services/AppCoordinator.swift")
        #expect(path == "SuperduperDictation/Services/AppCoordinator.swift")
    ...
    @Test func idempotentForAlreadyFormattedMention() {
        let result = sut.formatMention(
            originalText: "@SuperduperDictation/Services/AppCoordinator.swift",
            resolution: .resolved(makeCandidate(score: 0.9)),
            capabilities: cursorCapabilities
        )
    ...
    @Test func differentPrefixPerApp() {
        ...
        #expect(vscodeText == "@SuperduperDictation/Services/AppCoordinator.swift")
        ...
        #expect(zedText == "/SuperduperDictation/Services/AppCoordinator.swift")
    }
    ...
    @Test func batchFormatReport() {
        ...
        #expect(report.formattedText.contains("@SuperduperDictation/Services/AppCoordinator.swift"))
