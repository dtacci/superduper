...
struct ModelManagerTests {
    ...
    @Test func offlineDiarizationReadinessRecognizesCurrentFluidAudioLayout() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("superduper-diarization-readiness-\(UUID().uuidString)", isDirectory: true)
    ...
    @Test func offlineDiarizationReadinessRetainsLegacyCompatibility() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("superduper-diarization-legacy-\(UUID().uuidString)", isDirectory: true)
        defer { try? FileManager.default.removeItem(at: root) }
    ...
    @Test func offlineDiarizationReadinessDiagnosesPartialAndCorruptCaches() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("superduper-diarization-corrupt-\(UUID().uuidString)", isDirectory: true)
        defer { try? FileManager.default.removeItem(at: root) }
    ...
    @Test func diarizationRepairRemovalDoesNotTouchOtherFeatureModels() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("superduper-diarization-repair-\(UUID().uuidString)", isDirectory: true)
        defer { try? FileManager.default.removeItem(at: root) }
