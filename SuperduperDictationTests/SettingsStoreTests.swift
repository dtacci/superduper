...
struct SettingsStoreTests {
    ...
    @Test func renamedThemePresetIDsMigrateOnLaunch() {
        ...
        let store = SettingsStore.backingUserDefaults
        store.set("pindrop", forKey: SuperduperThemeStorageKeys.lightThemePresetID)
        store.set("paper", forKey: SuperduperThemeStorageKeys.darkThemePresetID)
    ...
    @Test func testThemeModeBridgesStoredValue() {
        ...
        #expect(settingsStore.themeMode == SuperduperThemeMode.light.rawValue)
    ...
    @Test func testThemePresetFallsBackToDefaultForUnknownPresetID() {
        ...
        #expect(settingsStore.selectedLightThemePreset.id == SuperduperThemePresetCatalog.defaultPresetID)
        #expect(settingsStore.selectedDarkThemePreset.id == SuperduperThemePresetCatalog.defaultPresetID)
    }

    @Test func testThemeModeMapsToAppKitAppearance() {
        #expect(SuperduperThemeMode.system.appKitAppearanceName == nil)
        #expect(SuperduperThemeMode.light.appKitAppearanceName == .aqua)
        #expect(SuperduperThemeMode.dark.appKitAppearanceName == .darkAqua)
    }
