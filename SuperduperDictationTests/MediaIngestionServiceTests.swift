...
struct MediaIngestionServiceTests {
    private let fakeYTDLPPath = "/tmp/superduper-test-yt-dlp"
    private let fakeFFmpegPath = "/tmp/superduper-test-ffmpeg"
...
private final class MockProcessRunner: ProcessRunning, @unchecked Sendable {
    ...
    var expectedYTDLPPath = "/tmp/superduper-test-yt-dlp"
    var expectedFFmpegPath = "/tmp/superduper-test-ffmpeg"
