...
struct DictationAudioRetentionServiceTests {
    ...
    private func makeFixture(
        ...
        let directoryURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("superduper-dictation-audio-\(UUID().uuidString)", isDirectory: true)
...
struct WaveformPeaksTests {
    ...
    private func writeSineWaveWAV(
        ...
        let url = FileManager.default.temporaryDirectory
            .appendingPathComponent("superduper-sine-\(UUID().uuidString)")
    ...
    @Test func testPCMFileExtractMatchesBucketCountAndCancels() async throws {
        ...
        let pcmURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("superduper-pcm-\(UUID().uuidString)")
            .appendingPathExtension("pcm")
...
struct DictationRecoveryStoreTests {
    private func makeStore() throws -> (DictationRecoveryStore, URL) {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("superduper-recovery-tests-\(UUID().uuidString)", isDirectory: true)
