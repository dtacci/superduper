    ...
    var body: some View {
        Button {
            ...
            ZStack(alignment: isOn ? .trailing : .leading) {
                ...
                Circle()
                    .fill(Color(nsColor: NSColor(superduperHex: "#FCFBF7") ?? .white))
                    .frame(
...
struct SettingsThemePresetChip: View {
    ...
    let preset: SuperduperThemePreset
    ...
    private var accent: Color {
        ...
        return Color(nsColor: NSColor(superduperHex: hex) ?? .controlAccentColor)
    }
