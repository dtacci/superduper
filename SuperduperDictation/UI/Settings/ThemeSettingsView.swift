...
struct ThemeSettingsView: View {
        ...
        SettingsPaneStack {
            ...
            SettingsGroupCard {
                SettingsRow(showSeparator: false) {
                    ...
                    HStack(spacing: 6) {
                        ForEach(SuperduperThemeMode.allCases) { mode in
                            FilterChip(
    ...
    private var activeVariantForSwatches: SuperduperThemeVariant {
    ...
    private var presetsForActiveVariant: [SuperduperThemePreset] {
...
private struct FlowPresetChips: View {
    let presets: [SuperduperThemePreset]
