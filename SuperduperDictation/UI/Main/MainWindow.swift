...
final class MainWindowController {
    ...
    static let windowIdentifier = NSUserInterfaceItemIdentifier("com.dantacci.superduper-dictation.main-window")
    ...
    /// Whether `window` is the Superduper Dictation main window and currently key.
    ...
    private func show(navigationItem: MainNavItem?) {
        ...
        if window == nil {
            ...
            SuperduperThemeController.shared.apply(to: window)
