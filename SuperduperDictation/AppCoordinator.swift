...
extension Notification.Name {
    static let switchModel = Notification.Name("com.dantacci.superduper-dictation.switchModel")
    static let modelActiveChanged = Notification.Name("com.dantacci.superduper-dictation.modelActiveChanged")
    static let requestActiveModel = Notification.Name("com.dantacci.superduper-dictation.requestActiveModel")
    static let showWhatsNew = Notification.Name("com.dantacci.superduper-dictation.showWhatsNew")
    /// UI posts this with `userInfo["text"]` (String) to copy with clipboard-undo toast.
    static let copyTextWithUndo = Notification.Name("com.dantacci.superduper-dictation.copyTextWithUndo")
}
...
final class AppCoordinator {
    ...
    private let eventTapRunLoopThread = EventTapRunLoopThread(name: "com.dantacci.superduper-dictation.event-tap-runloop")
    ...
    init(
        ...
        let floatingIndicatorActions = FloatingIndicatorActions(
            ...
            // Sending fork reports to the upstream Superduper Dictation tracker is misleading.
            onReportIssue: nil,
    ...
    private func canRegisterHotkey(
        ...
        if let conflict = registrationState.register(
            ...
            // Pre-save inline feedback in HotkeysSettingsView covers Superduper Dictation-internal
    ...
    /// availability. With overlay streaming the live transcript renders in Superduper Dictation's own
    ...
    private func handleEscapeKeyPress() {
        // Escape cancels while Superduper Dictation owns an active recording/processing session.
