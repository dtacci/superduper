...
//
//  The complete catalog of telemetry signals Superduper Dictation can emit. Every signal name
...
enum TelemetryParameter {
    ...
    /// Selected transcription model identifier (a Superduper Dictation model name, never user content).
