...
final class AudioPCMFileStorage: @unchecked Sendable {
    ...
    private let writerQueue = DispatchQueue(label: "com.dantacci.superduper-dictation.audio-pcm-writer")
...
final class CoreAudioInputCaptureBackend: AudioCaptureBackend {
    ...
    var persistentSpoolDirectoryURL: URL?
    private let targetFormatStorage: AVAudioFormat
    private let callbackQueue = DispatchQueue(label: "com.dantacci.superduper-dictation.microphone-input")
...
final class SystemAudioTapCaptureBackend: AudioCaptureBackend {
    ...
    private let audioConverter = ReusableAudioConverter()
    private let targetFormatStorage: AVAudioFormat
    private let callbackQueue = DispatchQueue(label: "com.dantacci.superduper-dictation.system-audio-tap")
    ...
    private let controlQueue = DispatchQueue(label: "com.dantacci.superduper-dictation.system-audio-tap.control")
    ...
    private func createAggregateDevice(tapUID: String, outputDeviceUID: String) throws -> AudioObjectID {
        let aggregateUID = "com.dantacci.superduper-dictation.aggregate.\(UUID().uuidString)"
