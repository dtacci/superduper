#!/usr/bin/env python3
"""Localization pipeline for SuperduperDictation.
...
SOURCE_CATALOG_DIR = ROOT / "SuperduperDictation" / "Localization"
SOURCE_TREE_DIR = ROOT / "Localization"
GENERATED_DIR = ROOT / "SuperduperDictation" / "Generated"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="SuperduperDictation localization pipeline")
